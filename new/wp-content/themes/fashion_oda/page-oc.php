...
<header>
	<div class="wrap">
		<h1 class="logo"><a href="<?php echo esc_url(home_url('/oc/')); ?>" class="fade"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/logo_pc.png" alt="織田製菓専門学校" class="switch"></a></h1>
		<nav class="gnavi">
			<ul class="main">
				<li class="pc1260">
