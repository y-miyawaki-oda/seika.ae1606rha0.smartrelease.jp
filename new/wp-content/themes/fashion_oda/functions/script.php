<?php
	...
	function add_files() {
		...
		wp_enqueue_style('c-font05', 'https://fonts.googleapis.com/css2?family=Nunito:wght@400&display=swap', array('c-font04'), '1.0', 'all');
		wp_enqueue_style('c-font06', 'https://fonts.googleapis.com/css2?family=M+PLUS+1p:wght@400&display=swap', array('c-font05'), '1.0', 'all');
